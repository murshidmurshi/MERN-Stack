...
function Checkout() {
    ...
    const submitForm = (e) => {
        ...
        Axios.post("http://localhost:7000/api/user/shipping", details, {
            ...
            .then((res) => {
                console.log(res, "Shippingggggggg....");
        ...
        <div className="checkout">
            <div className="checkout-content">
                ...
                <form onSubmit={submitForm}>
                    ...
                    <div className="form-group">
                        <label htmlFor="payment">Payment required Type:</label>
                        <select required id="payment" name="payment_type"
                            onChange={handleChange} className="select-big">
                            <option selected disabled value="">Select Payemnt Type</option>
                            <option value="COD">COD</option>
                            <option value="UPI">UPI</option>
                        </select>
                    </div>
                    <button required type="submit" className="btn">
                        Place Order
                    </button>
                </form>
            </div>
